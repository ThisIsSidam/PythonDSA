...
# Date : 04/12/23
# Title : Exercise 6 - Subarray Sum

'''
Given an array of integers nums and a target integer target, write a Python 
function called subarray_sum that finds the indices of a contiguous subarray 
...
your function only needs to return the indices of any one such subarray. Also, 
